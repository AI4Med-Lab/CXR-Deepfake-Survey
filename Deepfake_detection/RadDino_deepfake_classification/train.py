...
def main():
    ...
    train_ds = CXRDeepfakeDataset(args["csv"], "train", processor, augment=train_augment)
    val_ds = CXRDeepfakeDataset(args["csv"], "val", processor)
    ...
    model = RadDinoDeepfakeClassifier(args["backbone"], num_unfrozen_blocks=0).to(device)
    ...
    # ---- Stage 1: linear probe on frozen backbone ----
    ...
    # ---- Stage 2: unfreeze last N blocks, fine-tune end-to-end ----
